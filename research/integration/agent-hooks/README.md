...
- automatic detection and installation for all four CLIs;
...
This smoke makes no model calls. Codex's full model → Bash → PostToolUse →
replacement → verifier path is exercised separately by the bounded Harbor
trial described in `research/benchmark/README.md`.
