...
(async () => {
  ...
  try {
    ...
    assert.strictEqual(initialized.detected.codex.supported, true);
    assert.strictEqual(initialized.detected.codex.replacementSupport, "supported-via-block-feedback");
